...
hero_story = {
    ...
    "lead": (
        "ಪ್ರಧಾನ ಮಂತ್ರಿ ನರೇಂದ್ರ ಮೋದಿ ಐತಿಹಾಸಿಕ ಶ್ರೀ ಕೃಷ್ಣ ಮಠದಲ್ಲಿ ಪವಿತ್ರ "
...
schedule = [
    ...
    {
        "time": "Nov 8 - Dec 7",
        "title": "Sant Sangama & Bhajanotsava",
        "description": (
...
dignitaries = [
    ...
    },
    {
        ...
        "note": "Reciting the concluding verses and inaugurating Kanaka Kavacha.",
    },
]
...
events = [
    ...
    {
        "title": "ಸಂತ ಸಂಗಮ",
        "title_en": "Sant Sangama",
        "category": "ಆಧ್ಯಾತ್ಮಿಕ ಸಂವಾದ",
        ...
        "highlight_en": "Sant Sandesha & Sant Sanmana honoring spiritual luminaries.",
        "image": "Udipi-Sri-Krishna.rev1_.webp",
    },
    {
        "title": "ಭಜನೋತ್ಸವ",
        "title_en": "Bhajanotsava",
        "category": "ಸಂಗೀತ",
        "category_en": "Music",
        "day": "Nov 20, 7:30 PM",
        "venue": "ಮಠ ಆವರಣ",
        "venue_en": "Math Courtyard",
        "summary": "ಭಗವಾನ್ ಕೃಷ್ಣನ ಲೀಲೆಗಳನ್ನು ಆಚರಿಸುತ್ತಾ ಉಡುಪಿಯಾದ್ಯಂತ ಪ್ರತಿಧ್ವನಿಸುವ ಆತ್ಮೀಯ ಕೀರ್ತನೆಗಳು.",
        "summary_en": "Soulful keertanas echo through Udupi celebrating Lord Krishna's leelas.",
        "highlight": "ಪೇಜಾವರ ಮಠದ ಗಾಯಕರ ಮಾರ್ಗದರ್ಶನದಲ್ಲಿ ಸಂವಾದಾತ್ಮಕ ಕೋರಸ್ ವಿಭಾಗಗಳು.",
        "highlight_en": "Interactive chorus segments guided by Pejawar Math vocalists.",
        "image": "Udupi-Krishna.webp",
    },
    {
        ...
        "day": "Nov 24, 10:00 AM",
        "venue": "ವಿದ್ಯಾಪೀಠ ಹಾಲ್",
        "venue_en": "Vidyapeetha Hall",
        "summary": "ಶಾಸ್ತ್ರ ಪಂಡಿತರು ಸಮಕಾಲೀನ ಸಂದರ್ಭದೊಂದಿಗೆ ಆಯ್ದ ಅಧ್ಯಾಯಗಳನ್ನು ವಿವರಿಸುತ್ತಾರೆ.",
        "summary_en": "Scripture scholars decode select chapters with contemporary context.",
        "highlight": "ಮಧ್ವ ತತ್ವಶಾಸ್ತ್ರ ಮತ್ತು ದ್ವೈತದ ಕುರಿತು ಆಳವಾದ ಚರ್ಚೆಗಳು.",
        "highlight_en": "Immersive discussions on Madhwa philosophy and dualism.",
        "image": "udupi-1536x864.webp",
    },
]
